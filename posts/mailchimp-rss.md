...
I was inspired to make a utility, similar to [my Duck Address Composer utility](/utilities/duck-compose), that makes it as simple as pasting a URL to subscribe with RSS.
...
My creatively-named [Mailchimp RSS](/utilities/mailchimp-rss) utility converts the `list-manage.com` profile and subscribe URLs to a `campaign-archive.com` feed URL by following Josh's instructions.
